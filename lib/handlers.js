...
const fedex = require('@my-org/fedex_pricing_module');
...
handlers.home = function(data, callback){
	...
	console.table(quote_params);
	console.table(credentials);

	//const call = new Fedex(credentials, quote_params);
	let x = fedex.getPricing(credentials, quote_params);
	console.log(x);
